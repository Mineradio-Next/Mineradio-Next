...
- KuGou concept-edition protocol adapters: API request structure and signing behavior were independently adapted with reference to [MakcRe/KuGouMusicApi](https://github.com/MakcRe/KuGouMusicApi) at revision `7a60b70` (MIT). Mineradio uses its own account isolation, cache model, UI, error handling, recommendation, playlist and playback integration; no upstream UI or brand assets are included.
