...
(function loadMineradioIndexModules() {
  ...
  const modulePaths = [
    ...
    'js/modules/05-playback/06b-unified-favorites.js',
    ...
    'js/modules/06-lyrics/04a-source-config.js',
    ...
    'js/modules/10-shell/04a-system-media-session.js',
    'js/modules/10-shell/04b-windows-shell-controls.js',
    'js/modules/10-shell/04c-mini-player.js',
