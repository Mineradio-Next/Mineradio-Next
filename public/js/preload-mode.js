try {
  var forceFullSplash = new URLSearchParams(location.search).get('startupForceSplash') === '1';
  if (!forceFullSplash && localStorage.getItem('mineradio-startup-fast-skip-v1') === '1') {
